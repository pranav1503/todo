                ...
                <div class="container-fluid">
                    <div class="row footer-top-inner-w3ls">
                        <div class="col-lg-4 col-md-6 footer-top ">
                            <h2>
                                <a href="index.php"><img src="<?php echo base_url(); ?>front_static/images/logo.png" alt="" style="height:50px;"><img src="<?php echo base_url(); ?>front_static/images/logo1.png" alt="" style="width:170px;"></a>
                            </h2>
                            <p class="my-3">Why LMF? <br><br>
                            ...
                            <div class="footer-w3pvt">
                                ...
                                <div class="last-w3ls-contact">
                                    <p>No 36, 1st Floor, Arogyapa Layout,
                                        <br> Kamanahalli Main Road, Bangalore
                                        <br>Karnataka, India.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="w3ls-footer text-center mt-4">
                        <ul class="list-unstyled w3ls-icons">
                            <li>
                                <a href="https://www.facebook.com/Leon-Maestro-De-Fitness-432718716887430/" target="_blank">
    							                       <span class="fa fa-facebook-f"></span>
    						                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/_u/leon_maestro_de_fitness/" target="_blank">
